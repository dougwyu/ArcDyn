...
# scp /Users/Negorashi2011/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/4_minimap2_samtools/_loop_minimap2_only_20190115.sh b042@hpc.uea.ac.uk:~/_ArcDyn/PlatesAB/PlatesAB_combined/
# scp /Users/Negorashi2011/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/4_minimap2_samtools/_loop_minimap2_only_20190115.bsub b042@hpc.uea.ac.uk:~/_ArcDyn/PlatesAB/PlatesAB_combined/
#
# scp /Users/Negorashi2011/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/4_minimap2_samtools/_loop_samtools_only_20190115.sh b042@hpc.uea.ac.uk:~/_ArcDyn/PlatesAB/PlatesAB_combined/
# scp /Users/Negorashi2011/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/4_minimap2_samtools/_loop_samtools_only_20190115.bsub b042@hpc.uea.ac.uk:~/_ArcDyn/PlatesAB/PlatesAB_combined/
...
cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/; ls
...
cd ~/_ArcDyn/PlatesAB/PlatesAB_combined
ls
...
cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA01; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA02; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA03; ls
bsub < ${MINIMAP2_BSUB}

cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA04; ls
bsub < ${MINIMAP2_BSUB}

cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA05; ls
bsub < ${MINIMAP2_BSUB}

cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA06; ls
bsub < ${MINIMAP2_BSUB}

cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA07; ls
bsub < ${MINIMAP2_BSUB}

cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA08; ls
bsub < ${MINIMAP2_BSUB}

cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA09; ls
bsub < ${MINIMAP2_BSUB}

cd ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA10; ls
bsub < ${MINIMAP2_BSUB}

bjobs
ls ~/_ArcDyn/PlatesAB/PlatesAB_combined/BWA01/minimap2_outputs # check
