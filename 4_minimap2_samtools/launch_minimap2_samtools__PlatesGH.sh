...
# scp /Users/Negorashi2011/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/4_minimap2_samtools/_loop_minimap2_only_20190115.sh b042@hpc.uea.ac.uk:~/_ArcDyn/PlatesGH/PlatesGH_combined/
# scp /Users/Negorashi2011/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/4_minimap2_samtools/_loop_minimap2_only_20190115.bsub b042@hpc.uea.ac.uk:~/_ArcDyn/PlatesGH/PlatesGH_combined/
#
# scp /Users/Negorashi2011/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/4_minimap2_samtools/_loop_samtools_only_20190115.sh b042@hpc.uea.ac.uk:~/_ArcDyn/PlatesGH/PlatesGH_combined/
# scp /Users/Negorashi2011/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/4_minimap2_samtools/_loop_samtools_only_20190115.bsub b042@hpc.uea.ac.uk:~/_ArcDyn/PlatesGH/PlatesGH_combined/
...
cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/; ls
...
head -n 8 BWA{01,02,03,04,05,06,07,08,09,10}/${MINIMAP2_BSUB} # check.  should be mnmpGH01
...
cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA01; ls
echo ${MINIMAP2_BSUB}
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA02; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA03; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA04; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA05; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA06; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA07; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA08; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA09; ls
bsub < ${MINIMAP2_BSUB}
bjobs

cd ~/_ArcDyn/PlatesGH/PlatesGH_combined/BWA10; ls
bsub < ${MINIMAP2_BSUB}
bjobs
