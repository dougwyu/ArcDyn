...
rm -rf ~/ArcDyn/PlatesAB/Earlham_soups/f16a1625-300b-4746-bfa3-61bbb36634d6/Sample_IPO3916_F5_working/ # there is a weird folder with very small files in there. Sample_IPO3916_F5/ is also present, also with small files. This is a failed sample
...
# mv ~/ArcDyn/amazon-glacier-douglasyu20190113.md5 ~/ArcDyn/Amazon_archive_files_to_rm_at_end/
# mv ~/ArcDyn/Plates*/Plates*.md5 ~/ArcDyn/Amazon_archive_files_to_rm_at_end/
ls ~/ArcDyn/Amazon_archive_files_to_rm_at_end
