...
idxstatsgenomecovfolder <- paste0("outputs_PlatesGH_", samtoolsfilter, "_", samtoolsqual, "_minimap2_outputs_20190204_349MITOCOICYTB")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups
# outputs_PlatesGH_F2308_f0x2_q48_minimap2_outputs_20190204_349MITOCOICYTB
# this is where i store the outputs of this script
outputidxstatstabulatefolder <- "GH_outputs_20190204_F2308_f0x2_q48_minimap2_349MITOCOICYTB"
...
# this step requires ~30 minutes to run for mitogenomes, ~ 2 mins to run for barcodes, ~1.5 hrs to run for MITOCOICYTB
...
# TIME SAVING STEP  After running once for mitogenomes and for barcodes, i save the file to avoid having to rerun the map() step
    ...
    # MITOCOICYTB
    # genomecoverages_summ <- readRDS(file.path(outputidxstatstabulatefolder, "genomecoverages_summ_PlatesGH_20190204_349MITOCOICYTB.RDS"))
   ...
   # saveRDS(file.path(genomecoverages_summ, file.path(outputidxstatstabulatefolder, "genomecoverages_summ_PlatesGH_minimap2_20190116_406barcodes.RDS"), compress = TRUE)
    saveRDS(genomecoverages_summ, file.path(outputidxstatstabulatefolder, "genomecoverages_summ_PlatesGH_20190204_349MITOCOICYTB.RDS"), compress = TRUE)
...
# write_tsv(idx_meta_genomecov, file.path(outputidxstatstabulatefolder, "idx_meta_genomecov_PlatesGH_20190204_349MITOCOICYTB.txt")) # output file for merging with the other RUN outputs
...
# idx_meta_genomecov <- read_delim(file.path(outputidxstatstabulatefolder, "idx_meta_genomecov_PlatesGH_20190204_349MITOCOICYTB.txt"), delim = "\t", escape_double = FALSE, trim_ws = TRUE)
```
...
# write_tsv(mocks_idx_meta_genomecov, file.path(outputidxstatstabulatefolder, "mocks_idx_meta_genomecov_PlatesGH_20190204_349MITOCOICYTB.txt")) # for merger with mock file from PlatesGH
...
# mocks_idx_meta_genomecov <- read_delim(file.path(outputidxstatstabulatefolder, "mocks_idx_meta_genomecov_PlatesGH_20190204_349MITOCOICYTB.txt"), delim = "\t", escape_double = FALSE, trim_ws = TRUE)
```
