...
scp ~/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/3_trimgalore_minimap2_samtools/loop_trimgalore_20180216.bsub b042@hpc.uea.ac.uk:~/ArcDyn/PlatesA2B2/PlatesA2B2_combined/
scp ~/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/ArcDyn_scripts/3_trimgalore_minimap2_samtools/_loop_trimgalore_20180221.sh b042@hpc.uea.ac.uk:~/ArcDyn/PlatesA2B2/PlatesA2B2_combined/
...
# cd ~/ArcDyn/PlatesA2B2/PlatesA2B2_combined/
...
parallel "sed 's/trimgal01/trimA2B2{}/g' BWA{}/${TRIMGALORE_BSUB} > BWA{}/${TRIMGALORE_BSUB}_tmp" ::: 01 02 03 04 05 06 07 08 09 10
parallel "mv BWA{}/${TRIMGALORE_BSUB}_tmp BWA{}/${TRIMGALORE_BSUB}" ::: 01 02 03 04 05 06 07 08 09 10
head -n7 BWA{01,02,03,04,05,06,07,08,09,10}/${TRIMGALORE_BSUB} # check.  should be trimA2B2{01,02,03,...}
...
ls ~/ArcDyn/PlatesA2B2/PlatesA2B2_combined/BWA10/Sample_PRO1322_PlateA_F3 # should show first set of trimmed files
